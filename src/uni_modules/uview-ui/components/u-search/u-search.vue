<template>
  <view class="u-search" @tap="clickHandler" :style="[{
    ...
    <view class="u-search__content" :style="{
      ...
      <input confirm-type="search" @blur="blur" :value="value" @confirm="search" @input="inputChange" :disabled="disabled" @focus="getFocus"
             :focus="focus" :maxlength="maxlength" placeholder-class="u-search__content__input--placeholder" :placeholder="placeholder"
      ...
      <view class="u-search__content__icon u-search__content__close" v-if="keyword && clearabled && focused" @tap="clear">
        <u-icon name="close" size="11" color="#ffffff" customStyle="line-height: 12px"></u-icon>
      </view>
    </view>
    <text :style="[actionStyle]" class="u-search__action" :class="[(showActionBtn || show) && 'u-search__action--active']"
 ...
 * @property {String}			color				输入框字体颜色（默认 '#757575' ）
